...
export const ALL_DOCTORS = [
  {
    ...
    qual:
      "B.D.S. Clinical Director with a focus on restorative dentistry, implants and smile rehabilitation. Reg. A-32987. Registered with Maharashtra State Dental Council.",
    photo: doctorAruna,
  ...
  {
    name: "Dr. Shantanu Madhusudan Harale",
    role: "Dental Surgeon",
    qual:
      "B.D.S — SARASWATI DHANWANTARI DENTAL COLLEGE AND HOSPITAL, PARBHANI (Pass out 2025). Registered with Maharashtra State Dental Council.",
  ...
  },
  {
    ...
    role: "Dental Surgeon",
    qual:
      "B.D.S — KIMSDU School of Dental Sciences, Karad (Pass out June 2011). Reg. A-22901. Registered with Maharashtra State Dental Council.",
    photo: doctorPawar,
  ...
  },
  {
    ...
    role: "Endodontist",
    qual:
      "B.D.S — Sri Ramachandra Institute of Higher Education and Research (2014-2019); M.D.S — Bharati Vidyapeeth Dental College and Hospital (2020-2023), Conservative Dentistry & Endodontics. Reg. 28746. Registered with Maharashtra State Dental Council.",
    photo: doctorVijay,
  ...
  },
  {
    ...
    role: "Pedodontist",
    qual:
      "B.D.S — Bharati Vidyapeeth Dental College and Hospital, Pune; M.D.S — Pediatric Dentistry (Pass out 2022). Reg. A-38558. Registered with Maharashtra State Dental Council.",
    photo: doctorMaya,
  ...
  {
    name: "Dr. Gangasagare Swati Gangadhar",
  ...
  },
  {
    ...
    qual:
      "B.D.S — A B Shetty, Mangalore (NITTE University); M.D.S — Oral & Maxillofacial Surgery (Pass out 2020). Fellowships: Craniomaxillofacial Trauma; Oral Oncology & Reconstruction. Reg. A-33113. Registered with Maharashtra State Dental Council.",
