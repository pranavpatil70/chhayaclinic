...
const reviews = [
  {
    ...
    text: "Best clinic in Katraj! Dr. Rakhi explained everything patiently. My teeth look amazing.",
    rating: 5,
  },
  {
    name: "Rohan Patil",
    treatment: "Root Canal",
    text: "I was terrified of RCT. The team made it completely painless. Will recommend to everyone.",
    rating: 5,
  },
  {
    name: "Suman Joshi",
    treatment: "Dental Implants",
    text: "Got two implants here. Great quality, fair price, zero pressure. Truly trustworthy.",
    rating: 5,
  },
  {
    name: "Ankita Desai",
    treatment: "Aligners",
    text: "Six months in and my smile is transformed. So glad I chose Chhaya over the big chains.",
    rating: 5,
  },
  {
    name: "Vikram More",
    treatment: "Cleaning & Checkup",
    text: "Spotless clinic, modern equipment, and a doctor who genuinely cares. Found my family dentist.",
    rating: 5,
  },
  {
    name: "Neha Kulkarni",
    treatment: "Pediatric",
    text: "My 6-year-old looks forward to her appointments. Says a lot about how kind they are.",
    rating: 5,
  },
];
